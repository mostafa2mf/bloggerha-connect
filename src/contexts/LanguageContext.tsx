...
const translations: Record<Lang, Record<string, string>> = {
  fa: {
    ...
    'hero.userDesc': 'با حساب کاربری خود وارد داشبورد شوید',
    ...
    'footer.email': 'tiamstyle.uk@gmail.com',
    'footer.phone': '۰۹۱۲۸۲۰۶۲۵۴',
  ...
  en: {
    ...
    'hero.userDesc': 'Log in with your account to access the dashboard',
